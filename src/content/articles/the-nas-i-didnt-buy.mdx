...
Right now the lab is two boxes and a nest of SAS cables in a wooden cubby. The endgame is drawn but not built: a single custom chassis, 349 by 199 by 126 millimeters, that mounts the mini PC and the drive cage side by side and hides the power supply underneath on standoffs. Front-loading bays, an 80-millimeter exhaust, real cable channels. Four CAD files so far, zero saw cuts.
